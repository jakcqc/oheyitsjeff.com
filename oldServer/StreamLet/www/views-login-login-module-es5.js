        ...
        _createClass(LoginPage, [{
          ...
          value: function onSubmit(comment) {
            ...
            if (success == 1) {
              ...
              this.router.navigate(['/home']); //after pass we need to set const that user is logged in and store their info in an object that we can call to get their userID, etc
            } else {
              console.log("fail");
              this.commentForm.reset();
